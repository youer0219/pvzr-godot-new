...
@export var move_force := 150.0       # 水平移动力
@export var max_speed := 40.0        # 期望的最大水平速度
@export var horizontal_jump_impulse := 30.0  # 横移时的跳跃冲量
@export var jump_impulse := 200.0     # 跳跃冲量
